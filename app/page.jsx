...
export default function Home() {
  ...
  return (
    <div>
      {!isOpen ? (
        <div className="landing-container text-light-300 text-center lg:mb-4 mb-3">
          ...
          <div>
            <button
              onClick={handleClick}
              className="body-bold-l bg-primary-300 hover:bg-light-300 text-light-300 hover:text-primary-400 font-bold lg:mt-10 mt-6 py-4 px-3 rounded-full inline-flex justify-center w-[240px]"
            >
              <svg
